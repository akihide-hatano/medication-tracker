            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    <div class="flex items-center justify-center">
                        <a href="{{ route('posts.calendar') }}" class="flex items-center justify-center px-6 py-4 bg-orange-600 text-white rounded-lg shadow-md hover:bg-orange-700 transition duration-300 transform hover:scale-105 text-lg font-semibold">
